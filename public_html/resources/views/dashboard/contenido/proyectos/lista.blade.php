                ...
                <div class="card-body" style="overflow-x:scroll">
                    <table class="table" id="datatable" style="overflow-x:scroll">
                        <thead>
                            ...
                            <th scope="col">Empleados externos</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->metros }}</td>
                                <td>{{ $item->emplooyes }}</td>
                                <td>{{ $item->emplooyes_ext }}</td>
                                <td>{{ $item->staff }}</td>
                                <td>{{ $item->status }}</td>
                                ...
                                <td class="actions_table">
                                    {!! $item->actions!!}
                                    <form style="display:none;" action="{{ route('eliminar_proyecto', $item->id) }}" class="d-inline" method="POST">
                                        @method('DELETE')
                                        @csrf
